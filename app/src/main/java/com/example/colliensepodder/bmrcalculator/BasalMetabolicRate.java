...
public class BasalMetabolicRate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextHeight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(BasalMetabolicRate.this)
                        .setTitle((CharSequence) "Select Height in Feet")
                        .setItems(charSequences, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int Cpp) {
                                BasalMetabolicRate.this.editTextHeight.setText(charSequences[Cpp]);
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(BasalMetabolicRate.this)
                        ...
                        .setItems(sequences, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int Cpp) {
                                BasalMetabolicRate.this.editTextInch.setText(sequences[Cpp]);
                            }
                        }).create().show();
            }
        });
        ...
        linearlayoutCalculate.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                if (edtTextage.getText().toString().equals("")) {
                    ...
                    BMRCalculator.Bmr bmr = BMRCalculator.getBmr
                            (BasalMetabolicRate.this.edtTextage.getText().toString().trim(),
                                    BasalMetabolicRate.this.editTextHeight.getText().toString().trim(),
                                    BasalMetabolicRate.this.editTextInch.getText().toString().trim(),
                                    BasalMetabolicRate.this.edtTextWeightKg.getText().toString().trim());
                    android.view.View inflate = getLayoutInflater().inflate(R.layout.dialog_bmr_calculation_results, null);
                    final AlertDialog create = new AlertDialog.Builder(BasalMetabolicRate.this).setView(inflate).create();
                    ...
                    textView.setTextColor(android.support.v4.content.ContextCompat.getColor(BasalMetabolicRate.this, i == 1 ?
                            R.color.green :
                            R.color.colorRed));
                    ...
                    textView.setTextColor(android.support.v4.content.ContextCompat.getColor(BasalMetabolicRate.this, i2));
    ...
    public static class BMRCalculator {
        public static String[] HEALTH_STATUS = new String[]{"For Male", "For Female"};
        ...
        public static Bmr getBmr(String age, String height, String feet, String kg) {
            ...
            double bmrmale = ((10 * weight_kg) + (6.25 * height_in_cm) - (5 * Age) + 5);

            Bmr str23 = new Bmr();
            str23.bmrIndex = String.format("%.1f Calories/Day", new Object[]{Double.valueOf(bmrmale)});
